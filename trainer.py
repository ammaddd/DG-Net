...
hyperparameters['teacher_w'] * self.loss_teacher )  )
    ...
    def save(self, snapshot_dir, iterations, num_gpu=1, comet_logger=None):
        ...
        comet_logger.log_model("dgnet", gen_name)
        comet_logger.log_model("dgnet", dis_name)
        comet_logger.log_model("dgnet", id_name)
        comet_logger.log_model("dgnet", opt_name)
